...
import {
  Conversation,
  ConversationType,
} from "../messages/entities/conversation.entity";
...
export async function seed() {
  ...
  try {
    ...
    try {
      ...
      if (tasksTableExists[0].exists) {
        ...
        if (!sprintIdExists[0].exists) {
          ...
          try {
            ...
            if (verifySprintId[0].exists) {
              console.log(
                "✅ sprintId column successfully added to tasks table",
              );
            } else {
              console.error(
                "❌ Failed to add sprintId column - verification failed",
              );
              ...
              `);
              console.log(
                `   Available columns: ${allColumns.map((c: any) => c.column_name).join(", ")}`,
              );
            }
            ...
            if (
              ...
              console.log(
                "⚠️  sprintId column might already exist with different case",
              );
            } else {
              console.error(
                `❌ Error adding sprintId column: ${alterError.message}`,
              );
        ...
        if (projectIdInfo.length > 0 && projectIdInfo[0].data_type === "uuid") {
          console.log(
            "📝 Converting projectId column from uuid to varchar(50)...",
          );
          await dataSource.query(`
            ALTER TABLE "tasks" 
        ...
        console.log(
          "⚠️  Tasks table does not exist yet - will be created during seeding",
        );
      }
    } catch (tableError: any) {
      console.error(
        `❌ Error checking/updating tasks table: ${tableError.message}`,
      );
    ...
    const spaceData = [
      {
        ...
        description:
          "Main engineering workspace for all development projects and technical initiatives",
        color: "#3B82F6",
        icon: "Code",
        memberIds: [
          users[0].id,
    ...
    const projectData = [
      {
        ...
        description:
          "Build a modern, scalable e-commerce platform with React, Node.js, and PostgreSQL. Features include user authentication, product catalog, shopping cart, payment processing, and order management.",
      ...
      },
      {
        ...
        description:
          "Complete redesign of the mobile application with modern UI/UX principles, improved performance, and enhanced user experience across iOS and Android platforms.",
        status: ProjectStatus.ACTIVE,
        progress: 45,
        color: "#8B5CF6",
        icon: "Smartphone",
      ...
      },
      {
        ...
        description:
          "Integrate third-party APIs for payment processing, shipping, analytics, and customer support. Implement webhook handling and API rate limiting.",
        status: ProjectStatus.ACTIVE,
        progress: 85,
        color: "#10B981",
        icon: "Zap",
      ...
      },
      {
        ...
        description:
          "Implement comprehensive testing framework with unit tests, integration tests, and E2E tests. Achieve 80%+ code coverage across all modules.",
      ...
      },
      {
        ...
        description:
          "Build real-time analytics dashboard for project insights, user behavior tracking, revenue metrics, and performance monitoring with interactive charts and filters.",
        status: ProjectStatus.ACTIVE,
        progress: 92,
        color: "#EF4444",
        icon: "BarChart",
      ...
      },
      {
        ...
        description:
          "Develop customer self-service portal with account management, support ticket system, billing history, and subscription management features.",
        status: ProjectStatus.ACTIVE,
        progress: 58,
        color: "#06B6D4",
        icon: "Users",
    ...
    try {
      ...
      `);
      console.log(
        `📋 Current tasks table columns: ${allColumns.map((c: any) => c.column_name).join(", ")}`,
      );

      const columnNames = allColumns.map((c: any) =>
      ...
      if (!hasSprintId) {
        ...
        console.log(
          `✅ Verified sprintId column exists as: ${verify[0].column_name}`,
        );
      } else {
        console.log("✅ sprintId column already exists");
      }
      ...
      console.error(
        `❌ Error verifying sprintId column: ${verifyError.message}`,
      );
      throw verifyError;
    }
    ...
    const taskData = [
      ...
      [
        {
          ...
          description:
            "Initialize monorepo, configure build tools, set up CI/CD pipeline",
        ...
        },
        {
          ...
          description:
            "JWT-based auth with refresh tokens, password reset, email verification",
        ...
        },
        {
          ...
          description:
            "Create PostgreSQL schema with proper relationships and indexes",
          status: TaskStatus.COMPLETE,
          priority: TaskPriority.HIGH,
        },
        {
          ...
          description:
            "RESTful API for products with filtering, sorting, and pagination",
          status: TaskStatus.IN_PROGRESS,
          priority: TaskPriority.HIGH,
        },
        {
          ...
          description:
            "Add to cart, update quantities, remove items, persist cart state",
      ...
      [
        {
          ...
          description: "Design user journey maps and low-fidelity wireframes",
          status: TaskStatus.COMPLETE,
          priority: TaskPriority.MEDIUM,
        },
        {
          ...
          description:
            "Establish design system with consistent colors and fonts",
          status: TaskStatus.COMPLETE,
          priority: TaskPriority.MEDIUM,
        },
        {
        ...
        },
        {
          ...
          description: "Ensure layouts work across all device sizes",
          status: TaskStatus.TODO,
          priority: TaskPriority.HIGH,
        },
        {
          title: "Conduct user testing sessions",
          description: "Gather feedback from beta users and iterate",
          status: TaskStatus.TODO,
          priority: TaskPriority.MEDIUM,
        },
      ],
      ...
      [
        ...
        {
          title: "Integrate shipping API",
          description:
            "Connect with FedEx and UPS APIs for shipping calculations",
          status: TaskStatus.COMPLETE,
          priority: TaskPriority.HIGH,
        },
        {
        ...
        },
        {
          ...
          description: "Configure error tracking and API usage analytics",
          status: TaskStatus.TODO,
      ...
      [
        {
          ...
          description: "Achieve 80% coverage for business logic",
          status: TaskStatus.IN_PROGRESS,
          priority: TaskPriority.HIGH,
        },
        {
          title: "Setup E2E testing infrastructure",
          description: "Configure Playwright/Cypress for end-to-end tests",
          status: TaskStatus.TODO,
          priority: TaskPriority.MEDIUM,
        },
        {
          title: "Configure test coverage reporting",
          description: "Set up coverage reports and CI integration",
          status: TaskStatus.TODO,
          priority: TaskPriority.LOW,
        },
        {
      ...
      [
        {
          ...
          description:
            "Design main dashboard structure with sidebar navigation",
          status: TaskStatus.COMPLETE,
          priority: TaskPriority.HIGH,
        },
        {
          title: "Implement real-time charts",
          description: "Build interactive charts using Chart.js/Recharts",
          status: TaskStatus.COMPLETE,
          priority: TaskPriority.HIGH,
        },
        {
          title: "Add filters and date range picker",
          description: "Implement filtering by date, project, category",
          status: TaskStatus.IN_PROGRESS,
          priority: TaskPriority.MEDIUM,
        },
        {
          title: "Optimize dashboard performance",
          description: "Implement lazy loading and data caching",
          status: TaskStatus.TODO,
          priority: TaskPriority.LOW,
        },
      ],
      ...
      [
        {
          title: "Design portal user interface",
          description: "Create mockups for customer-facing portal",
          status: TaskStatus.COMPLETE,
          priority: TaskPriority.HIGH,
        },
        {
          title: "Build account management module",
          description: "Profile editing, password change, preferences",
          status: TaskStatus.IN_PROGRESS,
          priority: TaskPriority.HIGH,
        },
        {
          title: "Implement support ticket system",
          description: "Create, view, and manage support tickets",
          status: TaskStatus.TODO,
          priority: TaskPriority.MEDIUM,
        },
        {
          title: "Add billing history page",
          description: "Display invoices and payment history",
          status: TaskStatus.TODO,
          priority: TaskPriority.MEDIUM,
        },
      ],
    ...
    for (let i = 0; i < projects.length; i++) {
      ...
      for (let j = 0; j < projectTasks.length; j++) {
        ...
        const sprintIndex =
          projectSprints.length > 0 ? j % projectSprints.length : null;
        const sprintId =
          sprintIndex !== null ? projectSprints[sprintIndex].id : null;
    ...
    for (let i = 0; i < 20; i++) {
      ...
      const expense = dataSource.getRepository(Expense).create({
        ...
        endDate:
          frequencies[i % frequencies.length] === ExpenseFrequency.ONE_TIME
    ...
    for (let i = 0; i < 6; i++) {
      ...
      const conversation = dataSource.getRepository(Conversation).create({
        ...
        spaceId:
          i < teamSpaces.length ? teamSpaces[i % teamSpaces.length].id : null,
      });
      const savedConv = await dataSource
    ...
    const notificationTemplates = [
      ...
      },
      {
        ...
        message: "Task deadline is approaching soon",
      },
      {
        type: NotificationType.INFO,
        title: "New comment",
